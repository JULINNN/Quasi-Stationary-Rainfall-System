...
!DATA fout0 /"/work1/summer/junyou/data.gpv??????????00.bin     "/

!------------------------------------------------
! read delta data
!------------------------------------------------
! READ dizg
OPEN (12, FILE='/work1/summer/naijie/rcp85/5-6_delta/dizg_rcp85_0.25_interp.bin',&
...
! read diua
OPEN (12, FILE='/work1/summer/naijie/rcp85/5-6_delta/diua_rcp85_0.25_interp.bin',&
          STATUS='OLD', ACCESS='DIRECT', FORM='UNFORMATTED', RECL=201*201*4) 
irec = 0
DO k = 1, deltalev
  irec = irec + 1
...
! read diva
OPEN (12, FILE='/work1/summer/naijie/rcp85/5-6_delta/diva_rcp85_0.25_interp.bin',&
          STATUS='OLD', ACCESS='DIRECT', FORM='UNFORMATTED', RECL=201*201*4) 
irec = 0
DO k = 1, deltalev
  irec = irec + 1
...
! read dita
OPEN (12, FILE='/work1/summer/naijie/rcp85/5-6_delta/dita_rcp85_0.25_interp.bin',&
          STATUS='OLD', ACCESS='DIRECT', FORM='UNFORMATTED', RECL=201*201*4) 
irec = 0
DO k = 1, deltalev
  irec = irec + 1
...
! read dihus
OPEN (12, FILE='/work1/summer/naijie/rcp85/5-6_delta/dihus_rcp85_0.25_interp.bin',&
          STATUS='OLD', ACCESS='DIRECT', FORM='UNFORMATTED', RECL=201*201*4) 
irec = 0
DO k = 1, deltalev
  irec = irec + 1
